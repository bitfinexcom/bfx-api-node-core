 ...
 * @example <caption>streaming candles</caption>
 ...
 *
 * @example <caption>streaming public trades</caption>
...
class Manager extends EventEmitter {
   ...
   *
   * @param {FullAuthArgs} [args] - defaults to values
   ...
   * @returns {SocketState} state - connection state
   */
  getWS (id) {
   ...
   *
   * @param {number} id - id
   * @param {SocketState} state - new connection state
   */
  updateWS (id, state) {
   ...
   *
   * @returns {SocketState} connection
   */
  openWS () {
